...
import {Container, Group, Title, SubTitle, Text, Meta, Item, Feature, FeatureTitle, FeatureClose, FeatureText, Maturity, Content, Image, Entities } from './styles/Card';
